...
print(propGenesPerCell)
print(propGenesDetectedALL)
print(propGenesDetectedNONE)
print(numGenesDetectedALL)
...
save.image("RDATA/compare_SIM-properties_unEQvsunEQ_v2.RData")
